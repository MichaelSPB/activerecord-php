...
/**
 * @version: $Id: Config.php 552 2018-07-16 11:02:30Z VasilevMV $
 */
...
class Config extends Singleton
{
	...
	public function set_cache($url, $options=array())
	{
        ...
        public function set_initialized_cache(CacheInterface $cache, $options=array())
        {
            Cache::$adapter = $cache;
            Cache::$options = array_merge(array('expire' => 30, 'namespace' => ''),$options);
        }
}
