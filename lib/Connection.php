...
/**
 * @version: $Id: Connection.php 552 2018-07-16 11:02:30Z VasilevMV $
 */
...
abstract class Connection
{
	 ...
	 * @var string
	 */
	const DATETIME_TRANSLATE_FORMAT = 'd-m-Y\TH:i:s';
	/**
	 ...
	 * @var string
	 */
	static $datetime_format = 'd-m-Y H:i:s T';
	/**
	...
	public function query($sql, &$values=array())
	{
		...
		if ($this->logging)
		{
			...
			$this->logger->debug(sprintf("%.3fs -- %s", $time, $query));
		}
		return $sth;
	}
